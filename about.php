      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white pt-3">Hrátky s Drdem</h1>
            ...
            <a href="gallery.php" class="btn bg-white text-dark">Navštívit galerii</a>
          </div>
        </div>
      </div>
          ...
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Časté scházení</h5>
                <p>Je-li čas, na hřišti vždy potkáte nás!</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-start mb-5 mt-5">
          <h3 class="text-white z-index-1 position-relative">Základní členové</h3>
          ...
          <div class="card card-profile overflow-hidden">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">Jumbo</h5>
                  <h6 class="text-info">Dinosaurus von Vlajkoznal</h6>
        ...
        <div class="col-lg-6 col-12">
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">Drd</h5>
                  <h6 class="text-info">panDrd</h6>
        ...
        <div class="col-lg-6 col-12">
          <div class="card card-profile overflow-hidden z-index-2">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">Jounas</h5>
                  <h6 class="text-info">Fjuro</h6>
                  <p>Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-6 col-12">
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
            <div class="row">
              ...
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">Tom V</h5>
                  <h6 class="text-info">Tom V?</h6>
                  <p>Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                </div>
              </div>
            </div>
