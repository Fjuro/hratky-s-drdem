...
<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Úprava článku</h1>
  <div class="mb-4"></div>
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Úprava článku</h6>
    </div>
    <div class="card-body">
        <?php
      ...
      <form action="server.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="updatearticle" class="btn btn-success">Uložit</button>
        </div>
      </form>
    </div>
  </div>
