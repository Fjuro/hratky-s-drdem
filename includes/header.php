    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="stats.php" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center">
              Statistiky
            </a>
          </li>
  
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a href="gallery.php" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center">
              Galerie
            </a>
          </li>
